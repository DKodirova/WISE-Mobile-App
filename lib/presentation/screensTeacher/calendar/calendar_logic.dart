...
import 'package:wise_app/presentation/screensTeacher/calendar/calendar_state.dart';
import 'package:wise_app/presentation/widgets/calendarUtils.dart';

class CalendarLogicT extends GetxController {
  final CalendarStateT state = CalendarStateT();
